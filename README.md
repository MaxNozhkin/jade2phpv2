...
[**Gulp plugin**](https://github.com/viktorbezdek/gulp-jade2phpv2) available.

## Purpose
Write Jade templates, parse them with original Jade parser (not a PHP port) and convert into equivalent PHP templates.

## Getting started
* install [**gulp**-jade2phpv2](https://github.com/viktorbezdek/gulp-jade2phpv2): `npm install --save gulp-jade2phpv2`
* install command line utility: `npm install -g jade2phpv2`
* install node module for API usage: `npm install --save jade2phpv2`
